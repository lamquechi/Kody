...
(function () {
  ...
  const VI = {
    ...
    [`the website you are inside of now is part of the practice, not separate from it. a reading room i built so the work would have somewhere quiet to live. i update it the way one rearranges a small apartment — not often, but with care.`]: `Trang web bạn đang ở trong lúc này là một phần của việc viết, không tách rời khỏi nó. Một phòng đọc tôi dựng nên để tác phẩm có một nơi yên tĩnh để sống. Tôi chỉnh sửa nó theo cách người ta sắp xếp lại một căn hộ nhỏ — <em>không thường xuyên, nhưng cẩn thận</em>.`,
